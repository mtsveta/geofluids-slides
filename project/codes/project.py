...
# The number of elements and species
...
# Auxiliary funtion that calculates the vector b of element amounts for
...
def element_amounts(kgH2O, molCO2, molNaCl, molCaCO3):
    ...
    b = [2*molH2O,                        # H
         ...
         molNaCl,                         # Cl
         molCaCO3]                        # Ca
    # Ensure the amounts of each element is greater than zero
...
################################################
#  Uncomment the code below to see some standalone calculations
...
#     T = 75 + 273.15  # in K
#     P = 100 * 1e5  # in Pa
#     b = element_amounts(kgH2O=1, molCO2=molesCO2, molNaCl=0.0, molCaCO3=molesCaCO3)
...
def solubilityCO2(I, T, P):
    b = element_amounts(kgH2O=1, molCO2=10, molNaCl=I, molCaCO3=0.0)
    state = equilibrate(T, P, b)
    i1 = species.index('HCO3-(aq)')
    i2 = species.index('CO3--(aq)')
    i3 = species.index('CO2(aq)')
    i4 = species.index('H2O(l)')
    amount_C_aqueous = state.n[i1] + state.n[i2] + state.n[i3]
    kgH2O = state.m[i4] * 1e-3  # mass in kg
    molality_C = amount_C_aqueous/kgH2O
    return molality_C
...
def solubilityCaCO3(molesCO2, I, T, P):
    # Implement here the function that calculates solubility of CaCO3.
    return 0.0


def dissolvedMassCaCO3(molesCO2, I, T, P):
    # Implement here the function that calculates the mass of dissolved CaCO3.
    return 0.0

# The number of points along x in the plot
npoints = 50
