...
\begin{itemize}
\item the amounts of H, O, C? \textbf{Answer}: 200 mols of H, 104 mols of O, and 2 mols of C.
\item the amount of electric charge, represented by element Z? \textbf{Answer}: the final charge must be equal to the initial charge. 
\end{itemize}
\rcol
\begin{itemize}
...
\visible<3>{
\centering
\href{http://etc.ch/UbWW}{http://etc.ch/UbWW} or \\
...
\begin{itemize}
\item for Python shell, you can use an online tool \href{http://repl.it/languages/python}{repl.it/languages/python}
\item Python source code can be download from \href{https://polybox.ethz.ch/index.php/s/0eoyyzHfloeMk1Y}{polybox}.
\end{itemize}
}
\end{frame}
%
...
\textbf{Source code}: \href{https://polybox.ethz.ch/index.php/s/4kiqklmnBtXs3pG}{polybox}.
...
\begin{itemize}
\item The \mathbf{chemical potential}, $\mu_{i}$, of a species is defined as:
\[
...
% --------------------------------------------------------------------------------------------------------------------%
%
\begin{frame}{Mass action equation and equilibrium constant of reaction  \; ii}
\begin{itemize}
...
\midrule
1 & \textrm{$\mathsf{H_{2}O(aq)}$}\tabularnewline
2 & \textrm{$\mathsf{H^{+}(aq)}$}\tabularnewline
3 & \textrm{$\mathsf{OH^{-}(aq)}$}\tabularnewline
4 & \textrm{$\mathsf{Na^{+}(aq)}$}\tabularnewline
5 & \textrm{$\mathsf{Cl^{-}(aq)}$}\tabularnewline
6 & \textrm{$\mathsf{HCO_{3}^{-}(aq)}$}\tabularnewline
7 & \textrm{$\mathsf{CO_{2}(aq)}$}\tabularnewline
8 & \textrm{$\mathsf{CO_{3}^{-2}(aq)}$}\tabularnewline
...
\begin{align*}
\mathsf{H_{2}O(aq)} & \mathrm{\rightleftharpoons H^{+}(aq)+OH^{-}(aq)}\tag{1}\\
\mathsf{HCO_{3}^{-}(aq)+H^{+}(aq)} & \mathrm{\rightleftharpoons CO_{2}(aq)+H_{2}O(aq)}\tag{2}\\
\mathsf{H_{2}O(aq)+CO_{2}(aq)} & \mathrm{\rightleftharpoons CO_{3}^{-2}(aq)+2H^{+}(aq)}\tag{3}\\
\mathsf{CO_{2}(g)} & \mathrm{\rightleftharpoons CO_{2}(aq)}\tag{4}\\
\mathsf{NaCl(s)} & \mathrm{\rightleftharpoons Na^{+}(aq)+Cl^{-}(aq)}\tag{5}
\end{align*}
