...
\begin{frame}{Example of coupled processes}
	...
	\begin{figure}[!t]
		\centering
		\includegraphics[width=0.48\textwidth]{figures/reactive-transport/steefel-coupling-example.png}
...
\begin{frame}{Petroleum reservoir simulation}
	\begin{itemize}
	\item {\bf Important characteristics} are the natures of the rock and of the fluids filling it.
	%
	\item 
	\end{itemize}
\end{frame}
...
% --------------------------------------------------------------------------------------------------------------------%
%
\begin{frame}{Example, Microbial souring of waterflooded reservoirs}
	\begin{figure}[!t]
	\centering
...
\end{frame}
%
\begin{frame}{Example, Main reactions in scavenging process}
	\Wider{
		\begin{figure}[!t]
			\centering
...
\end{frame}
%
\begin{frame}{Example, Discretization of the reactive transport model}
	\Wider{
		\begin{figure}[!t]
			\centering
