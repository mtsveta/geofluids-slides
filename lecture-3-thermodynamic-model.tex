...
\vskip 5pt
\begin{center}
\href{http://etc.ch/eCnt/?qr}{\textcolor{indigo(dye)}{\tt http://etc.ch/paWu}} or 
...
\end{frame}
%
\subsection{Activity coefficient model for aqueous ionic species, Davies model}
%
% --------------------------------------------------------------------------------------------------------------------%
...
\]
where $A_{\gamma}$ is a \textbf{Debye–Hückel parameter} defined as
\[
...
\begin{itemize}
\item \alert{\textbf{Question:}} What is the activity coefficient of species Na$^{+}$ in an aqueous solution with ionic strength $I=\unit[0.1]{molal}$ using the \emph{Davies activity coefficient model}:
\[
...
%
\begin{center}
\href{http://etc.ch/eCnt/?qr}{\textcolor{indigo(dye)}{\tt http://etc.ch/paWu}} \quad or \quad 
...
\end{frame}
%
\subsection{Activity coefficient model for H$_2$O(aq), Davies model}
%
% --------------------------------------------------------------------------------------------------------------------%
...
\end{frame}
%
\subsection{Activity coefficient model for CO$_2$(aq), Drummond model}
%
% --------------------------------------------------------------------------------------------------------------------%
...
\]
\item \alert{\textbf{Question}}: What happens to $m_{\mathsf{CO_{2}\text{(aq)}}}$ when $\gamma_{\mathsf{CO_{2}\text{(aq)}}}$
