...
\begin{itemize}
\item Because of \txtbf{non-ideal behavior of the mixtures}, the concentrations
...
\begin{figure}
\begin{centering}
\includegraphics[height=0.4\textheight]{figures/activity-models/-diagram-pt}
\par\end{centering}
...
\begin{figure}
\begin{centering}
\includegraphics[width=1\columnwidth]{figures/phase-diagram-pt}
\par\end{centering}
\caption{The phase diagram of a substance.}
\end{figure}
