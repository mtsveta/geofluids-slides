...
\begin{center}
	...
	\includegraphics[height=0.15\columnwidth]{figures/activity-models/poll-ionic-strength.png}
\end{center}
\hiddenpause
\vskip 5pt
...
%
\item \textbf{Exercise:} Check that the values of $\partial^{2}f/\partial x^{2}>0$
and $\partial^{2}f/\partial y^{2}<0$ at $(0,0)$. 
\hiddenpause
\item This implies that $(0,0)$ is a \alert{\bf saddle point}.
\end{itemize}
\end{columns}
...
\end{alignat*}
%
$\mu_{i}$ will be calculated exactly. But the Jacobian will be approximated.
%
\end{itemize}
