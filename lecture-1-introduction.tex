...
\centering 
\vskip 10pt
{\Large \href{http://etc.ch/UnUh}{http://etc.ch/UnUh}}\\ 
or \\[10pt]
...
%
	...
	\begin{itemize}
		...
		\end{align*}
		\item oxyhaemoglobin through the blood stream to cells
	\end{itemize}
\end{itemize}      
...
\begin{itemize}
	\item \alert{\textbf{Corrosion}}, a natural process that converts a refined metal into a more chemically stable form such as oxide, hydroxide, or sulfide.
		\begin{itemize}
		\item underground soil side corrosion
		\item atmospheric corrosion
		\item microbial corrosion
		\item high temperature corrosion
	\end{itemize}
	%
	\item \alert{\textbf{Fluid catalytic cracking (FCC)}}, a conversion processes used in petroleum refineries of the high-boiling point, high-molecular weight hydrocarbon fractions of petroleum crude oils into more valuable gasoline, olefinic gases, and other products.
\end{itemize}      
...
% --------------------------------------------------------------------------------------------------------------------%
%
\section{Defining the chemical system in the geochemical modeling problem}
%
...
\item solids: combination of several minerals
\item oil
...
%
\begin{itemize}
\item \href{https://github.com/mtsveta/reaktoro-jupyter/blob/geofluids-examples/tutorial/cl.database.ipynb}{\emph{Database class}} ($\approx$ 10min)
\item \href{https://github.com/mtsveta/reaktoro-jupyter/blob/geofluids-examples/tutorial/cl.chemical-editor.ipynb}{\emph{Chemical editor class}} ($\approx$ 5min)
\item \href{https://github.com/mtsveta/reaktoro-jupyter/blob/geofluids-examples/tutorial/cl.chemical-system.ipynb}{\emph{Chemical system class}} ($\approx$ 10min)
\end{itemize}
\end{frame}


% --------------------------------------------------------------------------------------------------------------------%
% Example of chemical system when substances H2O and CO2 are involved
% --------------------------------------------------------------------------------------------------------------------%
%
...
\item What happens if we put too much of the table salt? The phase of halite is very important because it has a point of solubility in water. 
\end{itemize}
\end{itemize}
