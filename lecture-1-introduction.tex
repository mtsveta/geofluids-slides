...
we will use Python and Reaktoro (\href{https://reaktoro.org/}{\textcolor{indigo(dye)}{\tt eaktoro.org}}, computational framework that provides numerical methods for modeling chemically reactive processes governed by either chemical equilibrium, chemical kinetics, etc).
\end{itemize}
...
\end{figure}
 ...
 \alert{\textbf{Source file}}: \href{https://github.com/mtsveta/reaktoro-jupyter/blob/geofluids-examples/scripts/eq.co2-solubility-in-nacl-brine.py}{\textcolor{indigo(dye)}{\tt eq.co2-solubility-in-nacl-brine.py}}.
...
\centering 
\vskip 10pt
{\Large \href{http://etc.ch/UnUh}{\textcolor{indigo(dye)}{\tt http://etc.ch/UnUh}}}\\ 
or \\[10pt]
...
%
\item To ask questions, you can use my email \href{svetlana.kyas@erdw.ethz.ch}{\textcolor{indigo(dye)}{\tt svetlana.kyas@erdw.ethz.ch}} or the \href{https://gitter.im/geofluids/community}{\textcolor{indigo(dye)}{\it Gitter chat}}.
\end{itemize}
...
\end{itemize}
%
\alert{\textbf{Note}}: See Jupyter notebook tutorial on  \href{https://github.com/mtsveta/reaktoro-jupyter/blob/geofluids-examples/tutorial/eq.co2-solubility-in-water.ipynb}{\textcolor{indigo(dye)}{\it Opening bottle of soda}}.
%
\end{frame}
%
% --------------------------------------------------------------------------------------------------------------------%
...
%
\begin{itemize}
\item \href{https://github.com/mtsveta/reaktoro-jupyter/blob/geofluids-examples/tutorial/cl.database.ipynb}{\textcolor{indigo(dye)}{\it Database class}} ($\approx$ 10min)
\item \href{https://github.com/mtsveta/reaktoro-jupyter/blob/geofluids-examples/tutorial/cl.chemical-editor.ipynb}{\textcolor{indigo(dye)}{\it Chemical editor class}} ($\approx$ 5min)
\item \href{https://github.com/mtsveta/reaktoro-jupyter/blob/geofluids-examples/tutorial/cl.chemical-system.ipynb}{\textcolor{indigo(dye)}{\it Chemical system class}} ($\approx$ 10min)
\end{itemize}
\end{frame}
