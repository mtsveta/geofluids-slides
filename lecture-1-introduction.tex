...
\vskip 10pt
{\bf Note}: See Jupyter notebook tutorial \href{https://github.com/mtsveta/reaktoro-jupyter/blob/geofluids-examples/tutorial/eq.co2-solubility-in-nacl-brine.ipynb}{\textcolor{indigo(dye)}{\it CO$_2$ solubility in NaCl-brine}}.
...
\emph{Reaktoro Jyputer Notebook Introduction Installation} with explanation on Reaktoro installation and Jupyter Notebook tutorials execution are available  \href{https://polybox.ethz.ch/index.php/s/qStBnxUnry648U5}{\textcolor{indigo(dye)}{\tt here}}. 
%
\item To ask questions, you can use my email \href{svetlana.kyas@erdw.ethz.ch}{\textcolor{indigo(dye)}{\tt svetlana.kyas@erdw.ethz.ch}} or the \href{https://gitter.im/geofluids/community}{\textcolor{indigo(dye)}{\it Gitter chat}} (requires the github account).
\end{itemize}
...
%\begin{itemize}
%%\item 
\href{https://github.com/mtsveta/reaktoro-jupyter/blob/geofluids-examples/tutorial/cl.database.ipynb}{\textcolor{indigo(dye)}{\it Database class}}, %($\approx$ 10min)
%\item 
