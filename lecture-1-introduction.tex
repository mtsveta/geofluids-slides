...
%($\approx$ 5min)
%\item
 \href{https://github.com/mtsveta/reaktoro-jupyter/blob/geofluids-examples/tutorial/cl.chemical-system.ipynb}{\textcolor{indigo(dye)}{\it Chemical system class}} with corresponding  \href{https://polybox.ethz.ch/index.php/s/qStBnxUnry648U5}{\textcolor{indigo(dye)}{\it explanation videos}}.  %($\approx$ 10min)
%\end{itemize}
\end{frame}
