...
\item \textbf{Note}: Other computational tasks will be given throughout the lectures as exercises and tutorials 
...
\begin{itemize}
	...
	\end{itemize}
	%
	\item \alert{\textbf{Fluid catalytic cracking (FCC)}}, a conversion process used in petroleum refineries of the high-boiling point, high-molecular weight hydrocarbon fractions of petroleum crude oils into more valuable gasoline, olefinic gases, and other products.
\end{itemize}      
...
\item What happens if we put too much of the table salt? The phase of halite is significant
